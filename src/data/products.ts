...
export const products: Product[] = [
  ...
  { id: "o1", name: "Óleo Premium Cãnhamo 5% (Isolate)", category: "Óleos e Tinturas", description: "Óleo base suave, ideal para iniciantes.", cost: 10.0, price: 25.0, stock: 100, image: "/premium_canhamo_oil.png", color: "linear-gradient(135deg, #1e3c27, #2a6344)", isPopular: true },
  { id: "o2", name: "Óleo Premium Cãnhamo 10% (Broad Spectrum)", category: "Óleos e Tinturas", description: "Perfeito para relaxamento diário.", cost: 15.0, price: 35.0, stock: 80, color: "linear-gradient(135deg, #2a6344, #42825e)" },
  { id: "o3", name: "Óleo Premium Cãnhamo 20% (Full Spectrum)", category: "Óleos e Tinturas", description: "Dose extra forte para necessidades intensas.", cost: 25.0, price: 55.0, stock: 50, color: "linear-gradient(135deg, #cfaa6b, #121812)" },
  { id: "o4", name: "Óleo Premium Cãnhamo 30% (Gold Edition)", category: "Óleos e Tinturas", description: "A concentração mais pura e forte disponível.", cost: 35.0, price: 75.0, stock: 30, image: "/premium_canhamo_oil.png", color: "linear-gradient(135deg, #dac496, #cfaa6b)", isPopular: true },
  ...
  { id: "f1", name: "Flor Cãnhamo Amnesia Haze (3g)", category: "Flores de Cãnhamo", description: "Sabor cítrico e perfil sativa vibrante.", cost: 9.0, price: 22.0, stock: 150, image: "/premium_canhamo_flower.png", color: "linear-gradient(135deg, #3c096c, #10002b)", isPopular: true },
  { id: "f2", name: "Flor Cãnhamo Gelato Premium (3g)", category: "Flores de Cãnhamo", description: "Doce, terroso e com aroma relaxante.", cost: 11.0, price: 25.0, stock: 120, color: "linear-gradient(135deg, #7b2cbf, #5a189a)" },
  { id: "f3", name: "Flor Cãnhamo White Widow (5g)", category: "Flores de Cãnhamo", description: "Um clássico rico em tricomas de Cãnhamo.", cost: 14.0, price: 35.0, stock: 90, color: "linear-gradient(135deg, #e0aaff, #c77dff)" },
  { id: "f4", name: "Flor Cãnhamo OG Kush (5g)", category: "Flores de Cãnhamo", description: "O perfil de terpenos original e inconfundível.", cost: 15.0, price: 38.0, stock: 100, image: "/premium_canhamo_flower.png", color: "linear-gradient(135deg, #2b9348, #007f5f)", isPopular: true },
