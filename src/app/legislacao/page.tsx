            ...
            <div className="glass-panel" style={{ padding: "40px" }}>
              ...
              <div style={{ display: "grid", gap: "30px" }}>
                <div>
                  ...
                  <a href="https://diariodarepublica.pt/dr/legislacao-consolidada/decreto-lei/1993-58872437" target="_blank" className="btn-text">Diário da República →</a>
                </div>
                ...
                <div style={{ borderTop: "1px solid var(--glass-border)", paddingTop: "30px" }}>
                  ...
                  <a href="https://diariodarepublica.pt/dr/legislacao-consolidada/portaria/2021-163002068" target="_blank" className="btn-text">Consultar Portaria →</a>
                </div>
              </div>
            </div>
