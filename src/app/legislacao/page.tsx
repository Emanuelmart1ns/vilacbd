            ...
            <div className="glass-panel" style={{ padding: "40px" }}>
              ...
              <div style={{ display: "grid", gap: "30px" }}>
                <div>
                  ...
                  <a href="https://diariodarepublica.pt/dr/detalhe/decreto-lei/15-1993-239634" target="_blank" className="btn-text">Diário da República →</a>
                </div>
                ...
                <div style={{ borderTop: "1px solid var(--glass-border)", paddingTop: "30px" }}>
                  ...
                  <a href="https://diariodarepublica.pt/dr/detalhe/portaria/83-2021-161582298" target="_blank" className="btn-text">Consultar Portaria →</a>
                </div>
              </div>
            </div>
